 ...
 * @author PERSONAL
 */
public class HeadViewBooking extends javax.swing.JFrame {

    public HeadViewBooking() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"       Debu ", "  Seoul Garden", "     5/10/2024", "    12:30 pm", "     Reserve"},
                {"     Exhibition", "Covered Court", "     5/21/2024", "    10:00 am", "     Reserve"},
                {"   Dance Show ", "     Star Mall", "     6/8/2024", "     3:00 pm", "     Reserve"},
                {"      Seminar", " Queen's Land", "     5/15/2024", "     1:00 pm", "     Reserve"},
                {"      Kids Party", "      Jollibee", "     5/29/2024", "     8:30 am", "      Reserve"}
            },
            new String [] {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 170, 670, 580));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HeadViewBooking.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HeadViewBooking().setVisible(true);
            }
        });
    }
